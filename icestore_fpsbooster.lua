...
local function createOverlay()
    ...
    button.MouseButton1Click:Connect(function()
        ...
        gui.Enabled = getgenv().BlackModeConfig.enableBlackOverlay
...
local function toggleOverlay()
    ...
    if overlayOn then
        ...
        local gui = game:GetService("CoreGui"):FindFirstChild("IceStoreBlackModeGUI")
