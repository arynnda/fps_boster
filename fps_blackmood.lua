...
-- Terapkan optimisasi aman client-side
local function applySafeOptimizations(enable)
    ...
    -- Sembunyikan semua part termasuk karakter kita sendiri
...
-- Monitor object baru di workspace
...
local function createOverlay()
    ...
    ownerLabel.ZIndex = frame.ZIndex + 1
...
local function toggleOverlay()
    ...
    if overlayOn then
        ...
        local gui = game:GetService("CoreGui"):FindFirstChild("CicaBlackModeGUI")
